		...
		<html>
			...
			<body>
				...
				<div align='center'>
					...
					<b>REKAP DATA STATUS SISWA SUDAH DITERIMA</b><br/>
				...
				<p><b> A. REKAP DATA STATUS PENDAFTAR</b></p>
				...
				<table class='table'>
					...
					<tbody>
						...
						";
							...
							$pendaftarQ = mysqli_query($koneksi,"SELECT * FROM daftar  where daftar_ulang='1' and status_bayar='1' group by baju");
